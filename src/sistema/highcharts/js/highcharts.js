...
(function() {
	...
	function zd(a, b, c, d) {
		...
		return e + (g ? c.substr(0, g) + d : "")
				+ c.substr(g).replace(/(\d{3})(?=\d)/g, "$1" + d)
				+ (f ? b + $a(a - c).toFixed(f).slice(2) : "")
	}
	function Ad() {
	...
	function Bd() {
		...
		Dc = a ? Date.UTC : function(b, c, d, e, f, g) {
			return (new Date(b, c, C(d, 1), C(e, 0), C(f, 0), C(g, 0)))
					.getTime()
		};
	...
	function Gd(a, b) {
		function c(m, i) {
			...
			function Q(k, o, r) {
				...
				this.alignOptions = {
					...
					verticalAlign : k.verticalAlign
							|| (qa ? "middle" : o ? "bottom" : "top"),
					y : C(k.y, qa ? 4 : o ? 14 : -6),
					x : C(k.x, qa ? o ? -6 : 6 : 0)
				};
				this.textAlign = k.textAlign
						|| (qa ? o ? "right" : "left" : "center")
			}
			function na() {
				var k = [], o = [], r;
				T = ra = null;
				...
				u(
						...
						function(q) {
							...
							u(
									...
									function(ma) {
										if (q.isCartesian
												&& (ma === "xAxis" && Ga || ma === "yAxis"
														&& !Ga)
												&& (q.options[ma] === i.index || q.options[ma] === Va
														&& i.index === 0)) {
											q[ma] = v;
											Fa.push(q);
											r = true
							...
							if (!q.visible && w.ignoreHiddenSeries)
								r = false;
							if (r) {
								var A, U, G, V, Ba;
								if (!Ga) {
								...
								if (q.isCartesian) {
									u(
											q.data,
											function(ma) {
												var s = ma.x, W = ma.y, ba = W < 0, ia = ba ? G
														: U, zb = ba ? Ba : V;
												if (T === null)
													T = ra = ma[$];
												if (Ga)
									...
									if (/(area|column|bar)/.test(q.type) && !Ga)
										if (T >= 0) {
											T = 0;
											Hd = true
										} else if (ra < 0) {
			...
			function Ma() {
				...
				k = i.maxZoom
						|| (Ga && !M(i.min) && !M(i.max) ? qb(
								m.smallestInterval * 5, ra - T) : null);
				oa = z ? Ca : xa;
				if (Rb) {
				...
				if (!Xa && !Jc && !Rb && M(ca) && M(fa)) {
					k = fa - ca || 1;
					if (!M(i.min) && !M(Ja) && Jd && (T < 0 || !Hd))
						ca -= k * Jd;
					if (!M(i.max) && !M(Oa) && Kd && (ra > 0 || !Id))
						fa += k * Kd
				}
				Ta = ca === fa ? 1 : Rb && !A
						&& U === r.options.tickPixelInterval ? r.tickInterval
						: C(A, Xa ? 1 : (fa - ca) * U / oa);
				if (!F && !M(i.tickInterval))
					Ta = O(Ta);
				v.tickInterval = Ta;
				Kc = i.minorTickInterval === "auto" && Ta ? Ta / 5
						: i.minorTickInterval;
				if (F) {
					ta = [];
					A = Wa.global.useUTC;
					var G = 1E3 / rb, V = 6E4 / rb, Ba = 36E5 / rb;
					U = 864E5 / rb;
					k = 6048E5 / rb;
					q = 2592E6 / rb;
					var ma = 31556952E3 / rb, s = [
							...
							[ "day", U, [ 1, 2 ] ], [ "week", k, [ 1, 2 ] ],
							[ "month", q, [ 1, 2, 3, 4, 6 ] ],
							[ "year", ma, null ] ], W = s[6], ba = W[1], ia = W[2];
					for (r = 0; r < s.length; r++) {
						W = s[r];
						ba = W[1];
						ia = W[2];
						if (s[r + 1])
							if (Ta <= (ba * ia[ia.length - 1] + s[r + 1][1]) / 2)
								break
					}
					if (ba === ma && Ta < 5 * ba)
						ia = [ 1, 2, 5 ];
					...
					if (ba >= G)
						ia
								.setSeconds(ba >= V ? 0 : s
										* kb(ia.getSeconds() / s));
					if (ba >= V)
						ia[Cd](ba >= Ba ? 0 : s * kb(ia[bd]() / s));
					if (ba >= Ba)
						ia[Dd](ba >= U ? 0 : s * kb(ia[cd]() / s));
					if (ba >= U)
						ia[ed](ba >= q ? 1 : s * kb(ia[sc]() / s));
					if (ba >= q) {
			...
			function Aa() {
				...
				if (!Ga)
					for (k in t)
						for (o in t[k])
							t[k][o].cum = t[k][o].total;
				if (!v.isDirty)
					v.isDirty = ca !== Gb || fa !== Ld
			}
			function Qa(k) {
				k = (new x(k)).render();
				Sb.push(k);
			...
			function Ra() {
				var k = i.title, o = i.stackLabels, r = i.alternateGridColor, q = i.lineWidth, A, U, G = m.hasRendered, V = G
						&& M(Gb) && !isNaN(Gb);
				...
				if (A || Rb) {
					...
					G
							|| u((i.plotLines || []).concat(i.plotBands || []),
									function(s) {
				...
				if (q) {
					A = Y + (Ka ? Ca : 0) + P;
					U = Ua - sb - (Ka ? xa : 0) + P;
					A = ga.crispLine( [ ab, z ? Y : A, z ? U : ha, La,
							z ? Ya - Hb : A, z ? U : Ua - sb ], q);
					if (ka)
						ka.animate( {
							d : A
						});
				...
				if (v.axisTitle) {
					...
					q = (z ? ha + xa : Y) + (z ? 1 : -1) * (Ka ? -1 : 1) * gd
							+ (Z === 2 ? q : 0);
					v.axisTitle[G ? "animate" : "attr"]( {
						x : z ? A : q + (Ka ? Ca : 0) + P + (k.x || 0),
						y : z ? q - (Ka ? xa : 0) + P : A + (k.y || 0)
					})
				}
				if (o && o.enabled) {
					var Ba, ma;
					o = v.stackTotalGroup;
					if (!o)
						v.stackTotalGroup = o = ga.g("stack-labels").attr( {
							visibility : Ab,
							zIndex : 6
						}).translate(Y, ha).add();
					for (Ba in t) {
			...
			function Za(k) {
				for ( var o = Sb.length; o--;)
					Sb[o].id === k && Sb[o].destroy()
			}
			var Ga = i.isX, Ka = i.opposite, z = qa ? !Ga : Ga, Z = z ? Ka ? 0
					: 2 : Ka ? 1 : 3, t = {};
			i = va(Ga ? Mc : hd, [ Xd, Yd, Md, Zd ][Z], i);
			var v = this, N = i.type, F = N === "datetime", H = N === "logarithmic", P = i.offset || 0, $ = Ga ? "x"
					: "y", oa, ua, fb, eb = z ? Y : sb, Ib, Tb, gc, L, ka, T, ra, Fa, Ja, Oa, fa = null, ca = null, Gb, Ld, Jd = i.minPadding, Kd = i.maxPadding, Rb = M(i.linkedTo), Hd, Id, Jc;
			N = i.events;
			var id, Sb = [], Ta, Kc, Fb, ta, tb = {}, Zb = {}, fc = {}, hc, ic, gd, Lc, Xa = i.categories, $d = i.labels.formatter
					|| function() {
						var k = this.value;
						return Lc ? Nc(Lc, k) : Ta % 1E6 === 0 ? k / 1E6 + "M"
								: Ta % 1E3 === 0 ? k / 1E3 + "k" : !Xa
										&& k >= 1E3 ? zd(k, 0) : k
					}, Oc = z && i.labels.staggerLines, $b = i.reversed, ac = Xa
					&& i.tickmarkPlacement === "between" ? 0.5 : 0;
			y.prototype = {
				addLabel : function() {
					var k = this.pos, o = i.labels, r = !(k === ca
							&& !C(i.showFirstLabel, 1) || k === fa
							&& !C(i.showLastLabel, 0)), q = Xa && z
							&& Xa.length && !o.step && !o.staggerLines
							&& !o.rotation && Ca / Xa.length || !z && Ca / 2, A = this.label;
					k = $d.call( {
						isFirst : k === ta[0],
						isLast : k === ta[ta.length - 1],
						dateTimeLabelFormat : Lc,
						value : Xa && Xa[k] ? Xa[k] : k
					});
					q = q && {
						width : Ha(1, X(q - 2 * (o.padding || 10))) + bb
					};
					q = pa(q, o.style);
					if (A === Va)
						this.label = M(k) && r && o.enabled ? ga.text(k, 0, 0)
								.attr( {
									align : o.align,
									rotation : o.rotation
								}).css(q).add(gc) : null;
				...
				getLabelSize : function() {
					var k = this.label;
					return k ? (this.labelBBox = k.getBBox())[z ? "height"
							: "width"] : 0
				},
				render : function(k, o) {
					var r = !this.minor, q = this.label, A = this.pos, U = i.labels, G = this.gridLine, V = r ? i.gridLineWidth
							: i.minorGridLineWidth, Ba = r ? i.gridLineColor
							: i.minorGridLineColor, ma = r ? i.gridLineDashStyle
							: i.minorGridLineDashStyle, s = this.mark, W = r ? i.tickLength
							: i.minorTickLength, ba = r ? i.tickWidth
							: i.minorTickWidth || 0, ia = r ? i.tickColor
							: i.minorTickColor, zb = r ? i.tickPosition
							: i.minorTickPosition;
					r = U.step;
					var lb = o && Pc || Ua, Nb;
					Nb = z ? Ib(A + ac, null, null, o) + eb : Y + P
							+ (Ka ? (o && jd || Ya) - Hb - Y : 0);
					lb = z ? lb - sb + P - (Ka ? xa : 0) : lb
							- Ib(A + ac, null, null, o) - eb;
					if (V) {
						A = Tb(A + ac, V, o);
						if (G === Va) {
							G = {
							...
							if (ma)
								G.dashstyle = ma;
							this.gridLine = G = V ? ga.path(A).attr(G).add(L)
									: null
						}
						G && A && G.animate( {
							d : A
					...
					if (ba) {
						...
						if (Ka)
							W = -W;
						V = ga.crispLine( [ ab, Nb, lb, La, Nb + (z ? 0 : -W),
								lb + (z ? W : 0) ], ba);
						if (s)
							s.animate( {
								d : V
				...
				render : function() {
					...
					if (r && M(r.text) && s && s.length && Ca > 0 && xa > 0) {
						r = va( {
							align : z && G && "center",
							x : z ? !G && 4 : 10,
							verticalAlign : !z && G && "middle",
							y : z ? G ? 16 : 10 : G ? 6 : -4,
							rotation : z && !G && 90
						}, r);
						if (!q)
							k.label = q = ga.text(r.text, 0, 0).attr( {
						...
						q.align(r, false, {
							x : W,
							y : ba,
							width : Ha.apply(sa, G) - W,
							height : Ha.apply(sa, s) - ba
						});
						q.show()
					} else
						q && q.hide();
			...
			Q.prototype = {
				...
				render : function(k) {
					...
					if (this.label)
						...
						this.label = m.renderer.text(o, 0, 0).css(
								this.options.style).attr( {
				...
				setOffset : function(k, o) {
					var r = this.isNegative, q = v.translate(this.total), A = v
							.translate(0);
					A = $a(q - A);
					var U = m.xAxis[0].translate(this.x) + k, G = m.plotHeight;
					r = {
						x : qa ? r ? q : q - A : U,
						y : qa ? G - U - o : r ? G - q - A : G - q,
						width : qa ? A : o,
						height : qa ? o : A
					};
					this.label
							&& this.label.align(this.alignOptions, null, r)
									.attr( {
										visibility : Ab
									})
				}
			...
			pa(
					v,
					{
						...
						isXAxis : Ga,
						options : i,
						plotLinesAndBands : Sb,
						getOffset : function() {
							var k = Fa.length && M(ca) && M(fa), o = 0, r = 0, q = i.title, A = i.labels, U = [
									-1, 1, 1, -1 ][Z], G;
							if (!gc) {
								gc = ga.g("axis").attr( {
									zIndex : 7
							...
							if (q && q.text) {
								if (!v.axisTitle)
									v.axisTitle = ga.text(q.text, 0, 0).attr( {
										zIndex : 7,
								...
								o = v.axisTitle.getBBox()[z ? "height"
										: "width"];
								r = C(q.margin, z ? 5 : 10)
							}
							P = U * (i.offset || Ub[Z]);
		...
		function d() {
			var m = {};
			return {
				add : function(i, y, x, Q) {
					if (!m[i]) {
						y = ga.text(y, 0, 0).css(a.toolbar.itemStyle).align( {
							align : "right",
							x : -Hb - 20,
							y : ha + 30
						}).on("click", Q).attr( {
		...
		function e(m) {
			function i() {
				...
				var $ = Pb(P) || H, oa;
				oa = $ ? [ '<span style="font-size: 10px">'
						+ (H ? Nc("%A, %b %e, %Y", P) : P) + "</span>" ] : [];
				u(F, function(ua) {
			...
			var Q, na = m.borderWidth, O = m.crosshairs, ea = [], Ma = m.style, Aa = m.shared, Qa = ja(Ma.padding), Ra = na
					+ Qa, Za = true, Ga, Ka, z = 0, Z = 0;
			Ma.padding = 0;
			var t = ga.g("tooltip").attr( {
				zIndex : 8
			}).add(), v = ga.rect(Ra, Ra, 0, 0, m.borderRadius, na).attr( {
				fill : m.backgroundColor,
				"stroke-width" : na
			}).add(t).shadow(m.shadow), N = ga.text("", Qa + Ra,
					ja(Ma.fontSize) + Qa + Ra).attr( {
				zIndex : 1
			}).css(Ma).add(t);
			t.hide();
			return {
				...
				refresh : function(F) {
					...
					if (ua === false || !$)
						...
						v.attr( {
							width : Ga,
							height : Ka,
							stroke : m.borderColor || F.color || Q.color
									|| "#606060"
						});
						$ = H - Ga + Y - 25;
						P = P - Ka + ha + 10;
						...
						for (H = O.length; H--;) {
							...
							if (O[H] && P) {
								...
								if (ea[H])
									...
									$ = {
										"stroke-width" : O[H].width || 1,
										stroke : O[H].color || "#C0C0C0",
										zIndex : 2
									};
									if (O[H].dashStyle)
										$.dashstyle = O[H].dashStyle;
		...
		function f(m, i) {
			function y(z) {
				...
				Z = z.touches ? z.touches.item(0) : z;
			...
			function x(z) {
				...
				u(db, function(t) {
					var v = t.translate, N = t.isXAxis;
					Z[N ? "xAxis" : "yAxis"].push( {
						axis : t,
						value : v((qa ? !N : N) ? z.chartX - Y : xa - z.chartY
								+ ha, true)
					})
				});
				return Z
			...
			function na() {
				if (Aa) {
					var z = {
						xAxis : [],
						yAxis : []
					}, Z = Aa.getBBox(), t = Z.x - Y, v = Z.y - ha;
					if (Ma) {
						u(
								db,
								function(N) {
									var F = N.translate, H = N.isXAxis, P = qa ? !H
											: H, $ = F(P ? t : xa - v
											- Z.height, true, 0, 0, 1);
									F = F(P ? t + Z.width : xa - v, true, 0, 0,
											1);
									z[H ? "xAxis" : "yAxis"].push( {
										axis : N,
										min : qb($, F),
										max : Ha($, F)
									})
			...
			var O, ea, Ma, Aa, Qa = w.zoomType, Ra = /x/.test(Qa), Za = /y/
					.test(Qa), Ga = Ra && !qa || Za && qa, Ka = Za && !qa || Ra
					&& qa;
			Qc = function() {
				if (Rc) {
					Rc.translate(Y, ha);
					...
					m.trackerGroup = Rc = ga.g("tracker").attr( {
						zIndex : 9
					}).add()
			};
			Qc();
			...
			(function() {
				...
				var Z = function(t) {
					if (!(t && t.touches && t.touches.length > 1)) {
						...
						if (Jb && t.type === "touchstart")
							if (Ea(t.target, "isTracker"))
								m.runTrackerClick || t.preventDefault();
							else
								!ae && !F && t.preventDefault();
						if (F) {
							z || Q();
							if (v < Y)
								v = Y;
						...
						if (nd && t.type !== "touchstart") {
							Ma = Math.sqrt(Math.pow(O - v, 2)
									+ Math.pow(ea - N, 2));
							if (Ma > 10) {
								if (lc && (Ra || Za) && kc(O - Y, ea - ha))
									Aa
											|| (Aa = ga
													.rect(Y, ha, Ga ? 1 : Ca,
															Ka ? 1 : xa, 0)
							...
							N = m.hoverPoint;
							v = m.hoverSeries;
							var P, $, oa = Ya, ua = qa ? t.chartY : t.chartX
									- Y;
							if (uc && i.shared) {
								H = [];
								P = Ia.length;
				...
				ya.onclick = function(t) {
					...
					t.cancelBubble = true;
					if (!Ma)
						if (v && Ea(t.target, "isTracker")) {
							var N = v.plotX, F = v.plotY;
							pa(v, {
								pageX : tc.left + Y + (qa ? Ca - F : N),
								pageY : tc.top + ha + (qa ? xa - N : F)
							});
							Pa(v.series, "click", pa(t, {
								point : v
							}));
							v.firePointEvent("click", t)
						} else {
							pa(t, x(t));
							kc(t.chartX - Y, t.chartY - ha)
									&& Pa(m, "click", t)
						}
					Ma = false
				}
		...
		function h() {
			w.alignTicks !== false && u(db, function(m) {
				m.adjustTickAmount()
			});
			Mb = null
		}
		function j(m) {
			...
			u(Ia, function(ea) {
				if (ea.isDirty) {
					ea.cleanData();
					ea.getSegments();
					if (ea.options.legendType === "point")
						i = true
				}
			});
			...
			u(Ia, function(ea) {
				if (ea.isDirty && ea.visible && (!ea.isCartesian || ea.xAxis))
					ea.redraw()
			});
		...
		function n(m, i) {
			Kb = va(a.title, m);
			wc = va(a.subtitle, i);
			u( [ [ "title", m, Kb ], [ "subtitle", i, wc ] ], function(y) {
		...
		function J() {
			...
			p.renderer = ga = w.forExport ? new Vc(ya, Ya, Ua, true) : new Wc(
					ya, Ya, Ua);
			var m, i;
			if (Rd && ya.getBoundingClientRect) {
				m = function() {
					...
					Na(ya, {
						left : -(i.left - ja(i.left)) + bb,
						top : -(i.top - ja(i.top)) + bb
					})
				};
				m();
				Sa(cb, "resize", m);
		...
		function D() {
			function m() {
				var y = w.width || mb.offsetWidth, x = w.height
						|| mb.offsetHeight;
				if (y && x) {
					if (y !== Uc || x !== xc) {
						clearTimeout(i);
		...
		function aa() {
			...
			if (!p.seriesGroup)
				p.seriesGroup = ga.g("series-group").attr( {
					zIndex : 3
				}).add();
			u(Ia, function(x) {
				x.translate();
			...
			m.items
					&& u(m.items,
							function() {
								var x = pa(m.style, this.style), Q = ja(x.left)
										+ Y, na = ja(x.top) + ha + 12;
								delete x.left;
								delete x.top;
								ga.text(this.html, Q, na).attr( {
									zIndex : 2
								}).css(x).add()
							});
			if (!p.toolbar)
			...
			if (i.enabled && !p.credits) {
				y = i.href;
				ga.text(i.text, 0, 0).on("click", function() {
					if (y)
						location.href = y
				}).attr( {
		...
		function E() {
			...
			if (ga)
				ga.alignedObjects = null;
			clearInterval(Od);
			for (m in p)
				delete p[m]
		}
		function da() {
			if (!yc && cb == cb.top && wa.readyState !== "complete")
				wa.attachEvent("onreadystatechange", function() {
					wa.detachEvent("onreadystatechange", da);
		...
		R = Lb(R) ? R : [ R, R, R, R ];
		var B = C(w.marginTop, R[0]), K = C(w.marginRight, R[1]), S = C(
				w.marginBottom, R[2]), I = C(w.marginLeft, R[3]), za = w.spacingTop, Da = w.spacingRight, gb = w.spacingBottom, wb = w.spacingLeft, Ob, Kb, wc, ha, Hb, sb, Y, Ub, mb, Vb, ya, Pd, Uc, xc, Ya, Ua, jd, Pc, Xc, ud, vd, Yc, p = this, ae = (R = w.events)
				&& !!R.click, wd, kc, uc, nd, bc, Sd, xd, xa, Ca, jc, Rc, Qc, od, Wb, Xb, tc, lc = w.showAxes, Sc = 0, db = [], Mb, Ia = [], qa, ga, kd, Od, ld, pd, vc, sd, td, rd, md, Td, be = function(
				m) {
			function i(L, ka) {
				var T = L.legendItem, ra = L.legendLine, Fa = L.legendSymbol, Ja = Ka.color, Oa = ka ? O.itemStyle.color
						: Ja, fa = ka ? L.color : Ja;
				Ja = ka ? L.pointAttr[hb] : {
					stroke : Ja,
					fill : Ja
				};
				T && T.css( {
			...
			function x() {
				u(Qa, function(L) {
					...
					ka
							&& Na(ka, {
								left : T.translateX + L.legendItemWidth + ka.x
										- 40 + bb,
								top : T.translateY + ka.y - 11 + bb
							})
				})
			}
			function Q(L) {
				...
				if (!Ja) {
					...
					L.legendItem = Ja = ga.text(O.labelFormatter.call(L), 0, 0)
							.css(L.visible ? Za : Ka).on("mouseover",
									function() {
										L.setState(Bb);
										Ja.css(Ga)
								...
								L.setState()
									...
									function() {
										...
										L.firePointEvent ? L.firePointEvent(
												"legendItemClick", null, Gb)
												: Pa(L, "legendItemClick",
														null, Gb)
									}).attr( {
								zIndex : 2
							}).add(fb);
					if (!Fa && Oa && Oa.lineWidth) {
						...
						if (Oa.dashStyle)
							ca.dashstyle = Oa.dashStyle;
						L.legendLine = ga
								.path( [ ab, -Ma - Aa, 0, La, -Aa, 0 ])
								.attr(ca).add(fb)
					}
					if (Fa)
						ka = ga.rect(T = -Ma - Aa, ra = -11, Ma, 12, 2).attr( {
							zIndex : 3
						}).add(fb);
					else if (Oa && Oa.marker && Oa.marker.enabled)
						ka = ga.symbol(L.symbol, T = -Ma / 2 - Aa, ra = -4,
								Oa.marker.radius).attr( {
							zIndex : 3
						}).add(fb);
					if (ka) {
						ka.xOff = T + fa % 2 / 2;
			...
			function na() {
				...
				u(Tb, function(ra) {
					...
					if (Fa.showInLegend)
						Qa = Qa
								.concat(Fa.legendType === "point" ? ra.data
										: ra)
				});
				Qa.sort(function(ra, Fa) {
					return (ra.options.legendIndex || 0)
							- (Fa.options.legendIndex || 0)
				});
				gc && Qa.reverse();
				u(Qa, Q);
				Wb = Ib || eb;
				...
				if (oa || ua) {
					...
					if ($)
						Wb > 0 && Xb > 0
								&& $.animate($.crisp(null, null, null, Wb, Xb));
					else
						$ = ga.rect(0, 0, Wb, Xb, O.borderRadius, oa || 0)
								.attr( {
									stroke : O.borderColor,
									"stroke-width" : oa || 0,
									fill : ua || jb
								}).add(fb).shadow(O.shadow);
					$[Qa.length ? "show" : "hide"]()
				}
			...
			if (O.enabled) {
				var ea = O.layout === "horizontal", Ma = O.symbolWidth, Aa = O.symbolPadding, Qa, Ra = O.style, Za = O.itemStyle, Ga = O.itemHoverStyle, Ka = O.itemHiddenStyle, z = ja(Ra.padding), Z = 20, t = 18, v = 4
						+ z + Ma + Aa, N, F, H, P = 0, $, oa = O.borderWidth, ua = O.backgroundColor, fb, eb, Ib = O.width, Tb = m.series, gc = O.reversed;
				na();
				Sa(m, "endResize", x);
				return {
					colorizeItem : i,
					destroyItem : function(L) {
						var ka = L.checkbox;
						u( [ "legendItem", "legendLine", "legendSymbol" ],
								function(T) {
									L[T] && L[T].destroy()
								});
						ka && Gc(L.checkbox)
		...
		md = function(m) {
			...
			!m || m.resetSelection ? u(db, function(x) {
				...
				var Q = x.axis;
				if (p.tracker[Q.isXAxis ? "zoomX" : "zoomY"])
					Q.setExtremes(x.min, x.max, false, y)
			});
			j()
		};
		vc = function() {
			var m = a.legend, i = C(m.margin, 10), y = m.x, x = m.y, Q = m.align, na = m.verticalAlign, O;
			sd();
			if ((p.title || p.subtitle) && !M(B))
				if (O = Ha(p.title && !Kb.floating && !Kb.verticalAlign && Kb.y
						|| 0, p.subtitle && !wc.floating && !wc.verticalAlign
						&& wc.y || 0))
					ha = Ha(ha, O + C(Kb.margin, 15) + za);
			if (m.enabled && !m.floating)
				if (Q === "right")
					M(K) || (Hb = Ha(Hb, Wb - y + i + Da));
				else if (Q === "left")
					M(I) || (Y = Ha(Y, Wb + y + i + wb));
				else if (na === "top")
					M(B) || (ha = Ha(ha, Xb + x + i + za));
				else if (na === "bottom")
					M(S) || (sb = Ha(sb, Xb - x + i + gb));
			lc && u(db, function(ea) {
				ea.getOffset()
			});
			M(I) || (Y += Ub[3]);
		...
		pd = function() {
			var m = w.borderWidth || 0, i = w.backgroundColor, y = w.plotBackgroundColor, x = w.plotBackgroundImage, Q, na = {
				x : Y,
				y : ha,
				width : Ca,
				height : xa
			...
			if (m || i)
				if (Xc)
					Xc.animate(Xc.crisp(null, null, null, Ya - Q, Ua - Q));
				else
					Xc = ga.rect(Q / 2, Q / 2, Ya - Q, Ua - Q, w.borderRadius,
							m).attr( {
			...
			if (y)
				if (ud)
					...
					ud = ga.rect(Y, ha, Ca, xa, 0).attr( {
						fill : y
					}).add().shadow(w.plotShadow);
			if (x)
				if (vd)
					vd.animate(na);
				else
					vd = ga.image(x, Y, ha, Ca, xa).add();
			if (w.plotBorderWidth)
				if (Yc)
					Yc.animate(Yc.crisp(null, Y, ha, Ca, xa));
				else
					Yc = ga.rect(Y, ha, Ca, xa, 0, w.plotBorderWidth).attr( {
						stroke : w.plotBorderColor,
						"stroke-width" : w.plotBorderWidth,
						zIndex : 4
					}).add();
			p.isDirtyBox = false
		};
		...
		p.get = function(m) {
			...
			for (i = 0; i < db.length; i++)
				if (db[i].options.id === m)
					return db[i];
			for (i = 0; i < Ia.length; i++)
				if (Ia[i].options.id === m)
					return Ia[i];
			for (i = 0; i < Ia.length; i++) {
				x = Ia[i].data;
	...
	var wa = document, cb = window, sa = Math, X = sa.round, kb = sa.floor, fd = sa.ceil, Ha = sa.max, qb = sa.min, $a = sa.abs, nb = sa.cos, Db = sa.sin, cc = sa.PI, Ud = cc * 2 / 360, pc = navigator.userAgent, Bc = /msie/i
			.test(pc)
			&& !cb.opera, zc = wa.documentMode === 8, Nd = /AppleWebKit/
			.test(pc), Rd = /Firefox/.test(pc), yc = !!wa.createElementNS
			&& !!wa.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect, Wc, Jb = wa.documentElement.ontouchstart !== undefined, Vd = {}, qd = 0, rb = 1, Hc, Wa, Nc, Cc, $c, Va, Qb = "div", oc = "absolute", Qd = "relative", ub = "hidden", nc = "highcharts-", Ab = "visible", bb = "px", jb = "none", ab = "M", La = "L", Wd = "rgba(192,192,192,"
			+ (yc ? 1.0E-6 : 0.0020) + ")", hb = "", Bb = "hover", Dc, bd, cd, dd, sc, Ec, Fc, Cd, Dd, ed, Ed, Fd, la = cb.HighchartsAdapter, Eb = la
			|| {}, u = Eb.each, yd = Eb.grep, mc = Eb.map, va = Eb.merge, Sa = Eb.addEvent, Cb = Eb.removeEvent, Pa = Eb.fireEvent, Zc = Eb.animate, Tc = Eb.stop, vb = {};
	Nc = function(a, b, c) {
		function d(D) {
	...
	if (!la && cb.jQuery) {
		...
		Cb = function(a, b, c) {
			var d = wa.removeEventListener ? "removeEventListener"
					: "detachEvent";
			if (wa[d] && !a[d])
				a[d] = function() {
				};
		...
		ob.fx.prototype.cur = function() {
			var a = this.elem;
			return a.attr ? a.attr(this.prop) : de.apply(this, arguments)
		}
	}
	$c = {
		init : function(a, b, c) {
			...
			var h, j, l = function(n) {
				for (g = n.length; g--;)
					n[g] === ab
							&& n.splice(g + 1, 0, n[g + 1], n[g + 2], n[g + 1],
									n[g + 2])
			};
			if (e) {
				l(b);
	...
	Wa = {
		...
		credits : {
			enabled : false,
			text : "GestorSystem",
			href : "http://www.gestorsystem.com.br",
			position : {
				align : "right",
				x : -10,
				verticalAlign : "bottom",
	...
	var Yb = function(a) {
		var b = [], c;
		(function(d) {
			if (c = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/
					.exec(d))
				b = [ ja(c[1]), ja(c[2]), ja(c[3]), parseFloat(c[4], 10) ];
			else if (c = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/
					.exec(d))
				b = [ ja(c[1], 16), ja(c[2], 16), ja(c[3], 16), 1 ]
		})(a);
		return {
			get : function(d) {
				return b && !isNaN(b[0]) ? d === "rgb" ? "rgb(" + b[0] + ","
						+ b[1] + "," + b[2] + ")" : d === "a" ? b[3] : "rgba("
						+ b.join(",") + ")" : a
			},
			brighten : function(d) {
				if (dc(d) && d !== 0) {
	...
	Ic.prototype = {
		...
		attr : function(a, b) {
			var c, d, e, f, g = this.element, h = g.nodeName, j = this.renderer, l, n = this.shadows, J, D = this;
			if (Pb(a) && M(b)) {
				c = a;
				a = {};
				a[c] = b
			...
			if (Pb(a)) {
				...
				for (c in a) {
					...
					if (c === "d") {
						...
						if (this.rotation)
							Ea(g, "transform", "rotate(" + this.rotation + " "
									+ d + " " + ja(a.y || Ea(g, "y")) + ")")
					} else if (c === "fill")
						d = j.color(d, g, c);
						...
						if (d === "solid")
							...
							d = d.replace("shortdashdotdot", "3,1,1,1,1,1,")
									.replace("shortdashdot", "3,1,1,1")
									.replace("shortdot", "1,1,").replace(
		...
		symbolAttr : function(a) {
			...
			b.attr( {
				d : b.renderer.symbols[b.symbolName](X(b.x * 2) / 2,
						X(b.y * 2) / 2, b.r, {
							start : b.start,
							end : b.end,
							width : b.width,
		...
		align : function(a, b, c) {
			...
			c = C(c, this.renderer);
			var d = a.align, e = a.verticalAlign, f = (c.x || 0) + (a.x || 0), g = (c.y || 0)
					+ (a.y || 0), h = {};
		...
		add : function(a) {
			var b = this.renderer, c = a || b, d = c.element || b.box, e = d.childNodes, f = this.element, g = Ea(
					f, "zIndex");
		...
		shadow : function(a, b) {
			var c = [], d, e, f = this.element, g = this.parentInverted ? "(-1,-1)"
					: "(1,1)";
			if (a) {
				for (d = 1; d <= 3; d++) {
					e = f.cloneNode(0);
					...
					b ? b.element.appendChild(e) : f.parentNode.insertBefore(e,
							f);
					c.push(e)
				}
				this.shadows = c
	...
	Vc.prototype = {
		...
		buildText : function(a) {
			for ( var b = a.element, c = C(a.textStr, "").toString().replace(
					/<(b|strong)>/g, '<span style="font-weight:bold">')
					.replace(/<(i|em)>/g, '<span style="font-style:italic">')
					.replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g,
							"</span>").split(/<br.*?>/g), d = b.childNodes, e = /style="([^"]+)"/, f = /href="([^"]+)"/, g = Ea(
					b, "x"), h = a.styles, j = Rd && h
					&& h.HcDirection === "rtl" && !this.forExport
					&& ja(pc.split("Firefox/")[1]) < 4, l, n = h && ja(h.width), J = h
					&& h.lineHeight, D, aa = d.length; aa--;)
				b.removeChild(d[aa]);
			...
			u(
					...
					function(E, da) {
						var w, R = 0, B;
						E = E.replace(/<span/g, "|||<span").replace(
								/<\/span>/g, "</span>|||");
						w = E.split("|||");
						u(
								w,
								function(K) {
									if (K !== "" || w.length === 1) {
										...
										if (!R) {
											if (da) {
												!yc && a.renderer.forExport
														&& Na(I, {
															display : "block"
														});
												B = cb.getComputedStyle
														&& ja(cb
																.getComputedStyle(
																		D, null)
																.getPropertyValue(
		...
		setSize : function(a, b, c) {
			...
			this.width = a;
			this.height = b;
			for (this.boxWrapper[C(c, true) ? "animate" : "attr"]( {
				width : a,
				height : b
			}); e--;)
				d[e].align()
		...
		symbols : {
			square : function(a, b, c) {
				c = 0.707 * c;
				return [ ab, a - c, b - c, La, a + c, b - c, a + c, b + c,
						a - c, b + c, "Z" ]
			},
			triangle : function(a, b, c) {
				return [ ab, a, b - 1.33 * c, La, a + c, b + 0.67 * c, a - c,
						b + 0.67 * c, "Z" ]
			},
			...
			arc : function(a, b, c, d) {
				...
				f = Db(f);
				d = d.end - e < cc ? 0 : 1;
				return [ ab, a + c * h, b + c * j, "A", c, c, 0, d, 1,
						a + c * l, b + c * f, La, a + g * l, b + g * f, "A", g,
						g, 0, d, 0, a + g * h, b + g * j, "Z" ]
			}
		},
		clipRect : function(a, b, c, d) {
			var e = nc + qd++, f = this.createElement("clipPath").attr( {
				id : e
			}).add(this.defs);
	...
	if (!yc) {
		Eb = yb(
				...
				{
					init : function(a, b) {
						var c = [ "<", b, ' filled="f" stroked="f"' ], d = [
								"position: ", oc, ";" ];
						if (b === "shape" || b === Qb)
							d.push("left:0;top:0;width:10px;height:10px;");
						if (zc)
							d.push("visibility: ", b === Qb ? ub : Ab);
						c.push(' style="', d.join(""), '"/>');
						if (b) {
							c = b === Qb || b === "span" || b === "img" ? c
									.join("") : a.prepVML(c);
							this.element = ib(c)
						}
						this.renderer = a
					...
					attr : function(a, b) {
						...
						if (Pb(a)) {
							c = a;
							aa = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight
									: this[c]
						} else
							for (c in a) {
								d = a[c];
								...
								if (l
									...
									(f.getElementsByTagName("stroke")[0] || ib(
											j.prepVML( [ "<stroke/>" ]), null,
											null, f))[c] = d || "solid";
									this.dashstyle = d;
									n = true
								} else if (c === "fill")
					...
					updateTransform : function() {
						if (this.added) {
							...
							if (b.tagName === "SPAN") {
								...
								var D = 0, aa;
								J = ja(a.textWidth);
								var E = a.xCorr || 0, da = a.yCorr || 0, w = [
										c, g, b.innerHTML, a.textWidth ]
										.join(",");
								if (w !== a.cTT) {
									if (M(c)) {
										l = c * Ud;
						...
						if (a) {
							for (d = 1; d <= 3; d++) {
								j = [ '<shape isShadow="true" strokeweight="',
										7 - 2 * d, '" filled="false" path="',
										l, '" coordsize="100,100" style="',
										e.style.cssText, '" />' ];
								g = ib(f.prepVML(j), null, {
									left : ja(h.left) + 1,
									top : ja(h.top) + 1
								});
								j = [ '<stroke color="black" opacity="',
										0.05 * d, '"/>' ];
								ib(f.prepVML(j), null, null, g);
								b ? b.element.appendChild(g) : e.parentNode
										.insertBefore(g, e);
								c.push(g)
							}
							this.shadows = c
				...
				Vc.prototype,
				{
					...
					clipRect : function(a, b, c, d) {
						...
						return pa(e, {
							...
							height : d,
							getCSS : function(f) {
								var g = this.top, h = this.left, j = h
										+ this.width, l = g + this.height;
								g = {
									clip : "rect(" + X(f ? h : g) + "px,"
											+ X(f ? l : j) + "px,"
											+ X(f ? j : l) + "px,"
											+ X(f ? g : h) + "px)"
								};
					...
					color : function(a, b, c) {
						...
						if (a && a.linearGradient) {
							...
							a = 90 - sa.atan((h[3] - h[1]) / (h[2] - h[0]))
									* 180 / cc;
							c = [ "<", c, ' colors="0% ', j, ",100% ", n,
									'" angle="', a, '" opacity="', J,
									'" o:opacity2="', l,
					...
					symbols : {
						arc : function(a, b, c, d) {
							...
							if (f - e === 0)
								...
								j = nb(e + J);
							return [ "wa", a - c, b - c, a + c, b + c,
									a + c * g, b + c * h, a + c * j, b + c * l,
									"at", a - d, b - d, a + d, b + d,
									a + d * j, b + d * l, a + d * g, b + d * h,
									"x", "e" ]
						},
						circle : function(a, b, c) {
							return [ "wa", a - c, b - c, a + c, b + c, a + c,
									b, a + c, b, "e" ]
						},
						rect : function(a, b, c, d) {
							...
							var f = a + e, g = b + d;
							c = qb(c, e, d);
							return [ ab, a + c, b, La, f - c, b, "wa",
									f - 2 * c, b, f, b + 2 * c, f - c, b, f,
									b + c, La, f, g - c, "wa", f - 2 * c,
									g - 2 * c, f, g, f, g - c, f - c, g, La,
									a + c, g, "wa", a, g - 2 * c, a + 2 * c, g,
									a + c, g, a, g - c, La, a, b + c, "wa", a,
									b, a + 2 * c, b + 2 * c, a, b + c, a + c,
									b, "x", "e" ]
						}
					}
				});
	...
	Ac.prototype = {
		...
		destroy : function() {
			...
			Cb(a);
			u( [ "graphic", "tracker", "group", "dataLabel", "connector" ],
					function(d) {
						a[d] && a[d].destroy()
					});
		...
		tooltipFormatter : function(a) {
			var b = this.series;
			return [ '<span style="color:' + b.color + '">',
					this.name || b.name, "</span>: ",
		...
		firePointEvent : function(a, b, c) {
			...
			if (e.point.events[a] || d.options && d.options.events
					&& d.options.events[a])
				this.importEvents();
		...
		importEvents : function() {
			if (!this.hasImportedEvents) {
				var a = va(this.series.options.point, this.options).events, b;
				this.events = a;
				for (b in a)
					Sa(this, b, a[b]);
		...
		setState : function(a) {
			var b = this.series, c = b.options.states, d = xb[b.type].marker
					&& b.options.marker, e = d && !d.enabled, f = (d = d
					&& d.states[a])
					&& d.enabled === false, g = b.stateMarkerGraphic, h = b.chart, j = this.pointAttr;
			a = a || hb;
			if (!(a === this.state || this.selected && a !== "select" || c[a]
					&& c[a].enabled === false || a && (f || e && !d.enabled))) {
				if (this.graphic)
					this.graphic.attr(j[a]);
				else {
					if (a) {
						if (!g)
							b.stateMarkerGraphic = g = h.renderer.circle(0, 0,
									j[a].r).attr(j[a]).add(b.group);
	...
	pb.prototype = {
		...
		setData : function(a, b) {
			var c = this, d = c.data, e = c.initialColor, f = c.chart, g = d
					&& d.length || 0;
			c.xIncrement = null;
			if (M(e))
				f.counters.color = e;
		...
		translate : function() {
			for ( var a = this.chart, b = this.options.stacking, c = this.xAxis.categories, d = this.yAxis, e = this.data, f = e.length; f--;) {
				var g = e[f], h = g.x, j = g.y, l = g.low, n = d.stacks[(j < 0 ? "-"
						: "")
						+ this.stackKey];
				...
				if (M(l))
					g.yBottom = d.translate(l, 0, 1, 0, 1);
				if (j !== null)
					g.plotY = d.translate(j, 0, 1, 0, 1);
				g.clientX = a.inverted ? a.plotHeight - g.plotX : g.plotX;
				g.category = c && c[g.x] !== Va ? c[g.x] : g.x
			}
		},
		setTooltipPoints : function(a) {
			var b = this.chart, c = b.inverted, d = [], e = X((c ? b.plotTop
					: b.plotLeft)
					+ b.plotSizeX), f, g, h = [];
			if (a)
			...
			u(
					...
					function(j, l) {
						...
						for (g = j._high = d[l + 1] ? kb((j.plotX + (d[l + 1] ? d[l + 1].plotX
								: e)) / 2)
								: e; f <= g;)
							h[c ? e - f++ : f++] = j
					});
					...
					if (e !== Va && !isNaN(e)) {
						...
						if (j)
							...
							g.graphic = c.renderer
									.symbol(
											C(g.marker && g.marker.symbol,
													this.symbol), d, e, h)
									.attr(a).add(this.group)
					}
				}
		},
		...
		getAttribs : function() {
			var a = this, b = xb[a.type].marker ? a.options.marker : a.options, c = b.states, d = c[Bb], e, f = a.color, g = {
				stroke : f,
				fill : f
			}, h = a.data, j = [], l, n = a.pointAttrToOptions, J;
			if (a.options.marker) {
				d.radius = d.radius || b.radius + 2;
				d.lineWidth = d.lineWidth || b.lineWidth + 1
			} else
				d.color = d.color
						|| Yb(d.color || f).brighten(d.brightness).get();
			...
			for (f = h.length; f--;) {
				g = h[f];
				if ((b = g.options && g.options.marker || g.options)
						&& b.enabled === false)
					b.radius = 0;
				e = false;
				if (g.options)
				...
				if (e) {
					...
					e = c[Bb] = c[Bb] || {};
					if (!a.options.marker)
						e.color = Yb(e.color || g.options.color).brighten(
		...
		destroy : function() {
			var a = this, b = a.chart, c = /\/5[0-9\.]+ (Safari|Mobile)\//
					.test(pc), d, e;
			Pa(a, "destroy");
			Cb(a);
			...
			u( [ "area", "graph", "dataLabelsGroup", "group", "tracker" ],
					function(f) {
						if (a[f]) {
		...
		drawDataLabels : function() {
			if (this.options.dataLabels.enabled) {
				...
				if (!g)
					g = a.dataLabelsGroup = h.renderer.g("data-labels").attr( {
				...
				if (n === "auto")
					n = null;
				e.style.color = C(n, a.color);
				u(
						d,
						function(E) {
							var da = E.barX, w = da && da + E.barW / 2
									|| E.plotX || -999, R = C(E.plotY, -999), B = E.dataLabel, K = e.align, S = aa ? E.y > 0 ? -6
									: 12
									: e.y;
							...
							if (B) {
								if (j && !e.y)
									c = c + ja(B.styles.lineHeight) * 0.9
											- B.getBBox().height / 2;
								B.attr( {
									text : f
								}).animate( {
								...
								B = E.dataLabel = h.renderer.text(f, b, c)
										.attr( {
											align : K,
											rotation : e.rotation,
											zIndex : 1
								...
								j
										&& !e.y
										&& B.attr( {
											y : c + ja(B.styles.lineHeight)
													* 0.9 - B.getBBox().height
													/ 2
										})
							}
							if (J && a.options.stacking) {
								...
								E = E.barH;
								B.align(e, null, {
									x : j ? h.plotWidth - w - E : da,
									y : j ? h.plotHeight - da - R : w,
									width : j ? E : R,
									height : j ? R : E
								})
							}
		...
		drawGraph : function() {
			var a = this, b = a.options, c = a.graph, d = [], e, f = a.area, g = a.group, h = b.lineColor
					|| a.color, j = b.lineWidth, l = b.dashStyle, n, J = a.chart.renderer, D = a.yAxis
					.getThreshold(b.threshold || 0), aa = /^area/.test(a.type), E = [], da = [];
			u(a.segments,
					function(w) {
						n = [];
						u(w, function(S, I) {
							if (a.getPointSpline)
								n.push.apply(n, a.getPointSpline(w, S, I));
							else {
								n.push(I ? La : ab);
						...
						if (aa) {
							...
							if (b.stacking && a.type !== "areaspline")
								for (B = w.length - 1; B >= 0; B--)
									R.push(w[B].plotX, w[B].yBottom);
							else
								R.push(La, w[w.length - 1].plotX, D, La,
										w[0].plotX, D);
							da = da.concat(R)
						}
					});
			...
			a.singlePoints = E;
			if (aa) {
				e = C(b.fillColor, Yb(a.color)
						.setOpacity(b.fillOpacity || 0.75).get());
				if (f)
					f.animate( {
						d : da
					});
				else
					a.area = a.chart.renderer.path(da).attr( {
						fill : e
					}).add(g)
			}
			if (c)
		...
		render : function() {
			var a = this, b = a.chart, c, d, e = a.options, f = e.animation, g = f
					&& a.animate;
			f = g ? f && f.duration || 500 : 0;
			var h = a.clipRect, j = b.renderer;
			if (!h) {
				h = a.clipRect = !b.hasRendered && b.clipRect ? b.clipRect : j
						.clipRect(0, 0, b.plotSizeX, b.plotSizeY);
				if (!b.clipRect)
					b.clipRect = h
			}
			if (!a.group) {
		...
		setVisible : function(a, b) {
			...
			this.isDirty = true;
			this.options.stacking && u(c.series, function(n) {
		...
		drawTracker : function() {
			...
			if (d)
				for (l = d + 1; l--;) {
					c[l] === ab
							&& c.splice(l + 1, 0, c[l + 1] - f, c[l + 2], La);
					if (l && c[l] === ab || l === d)
						c.splice(l, 0, La, c[l - 2] + f, c[l - 1])
				}
			...
			if (g)
				...
				a.tracker = e.renderer.path(c).attr( {
					...
					visibility : a.visible ? Ab : ub,
					zIndex : 1
				}).on(Jb ? "touchstart" : "mouseover", function() {
	...
	la = yb(
			pb,
			{
				...
				getPointSpline : function(a, b, c) {
					...
					if (c) {
						b = [ "C", f.rightContX || f.plotX,
								f.rightContY || f.plotY, h || d, j || e, d, e ];
	...
	var ad = yb(
			pb,
			{
				...
				translate : function() {
					...
					h = $a(J[1] ? J[D].plotX - J[D - 1].plotX : b.plotSizeX
							/ (h && h.length || 1));
					D = h * c.groupPadding;
					var aa = (h - 2 * D) / f, E = c.pointWidth, da = M(E) ? (aa - E) / 2
							: aa * c.pointPadding, w = Ha(C(E, aa - 2 * da), 1), R = da
							+ (D
									+ ((g ? f - a.columnIndex : a.columnIndex) || 0)
									* aa - h / 2) * (g ? -1 : 1), B = a.yAxis
							.getThreshold(c.threshold || 0), K = C(
							c.minPointLength, 5);
					u(
							J,
							function(S) {
								var I = S.plotY, za = S.yBottom || B, Da = S.plotX
										+ R, gb = fd(qb(I, za)), wb = fd(Ha(I,
										za)
										- gb), Ob = a.yAxis.stacks[(S.y < 0 ? "-"
										: "")
										+ a.stackKey], Kb;
								d && a.visible && Ob && Ob[S.x]
										&& Ob[S.x].setOffset(R, w);
								if ($a(wb) < K) {
									if (K) {
										wb = K;
										gb = $a(gb - B) > K ? za - K : B
								...
								S.shapeType = "rect";
								I = pa(b.renderer.Element.prototype.crisp
										.apply( {}, [ e, Da, gb, w, wb ]), {
									r : c.borderRadius
								});
								if (e % 2) {
								...
								S.shapeArgs = I;
								S.trackerArgs = M(Kb) && va(S.shapeArgs, {
									height : Ha(6, wb + 3),
									y : Kb
								})
							})
							...
							function(f) {
								...
								if (g !== Va && !isNaN(g) && f.y !== null) {
									...
									if (d) {
										...
										f.graphic = c[f.shapeType]
												(e)
												.attr(
														f.pointAttr[f.selected ? "select"
																: hb]).add(
														a.group).shadow(
														b.shadow)
								}
					...
					u(a.data, function(l) {
						...
						if (l.y !== null)
							if (e)
								...
								l.tracker = c[l.shapeType](d).attr( {
									isTracker : f,
									fill : Wd,
									visibility : a.visible ? Ab : ub,
									zIndex : 1
								}).on(
										Jb ? "touchstart" : "mouseover",
										function(n) {
											j = n.relatedTarget
													|| n.fromElement;
											b.hoverSeries !== a
	...
	la = yb(
			Ac,
			{
				...
				setVisible : function(a) {
					...
					g = (this.visible = a = a === Va ? !this.visible : a) ? "show"
							: "hide";
					this.group[g]();
					c && c[g]();
					d && d[g]();
	...
	la = yb(
			pb,
			{
				...
				translate : function() {
					var a = 0, b = this, c = -0.25, d = b.options, e = d.slicedOffset, f = e
							+ d.borderWidth, g = d.center.concat( [ d.size,
							d.innerSize || 0 ]), h = b.chart, j = h.plotWidth, l = h.plotHeight, n, J, D, aa = b.data, E = 2 * cc, da, w = qb(
							j, l), R, B, K, S = d.dataLabels.distance;
					g = mc(g, function(I, za) {
						return (R = /%$/.test(I)) ? [ j, l, w, w ][za] * ja(I)
								/ 100 : I
					});
				...
				drawPoints : function() {
					...
					u(this.data, function(j) {
						...
						g = j.shadowGroup;
						if (f && !g)
							g = j.shadowGroup = b.g("shadow").attr( {
								zIndex : 4
							}).add();
						if (!e)
							e = j.group = b.g("point").attr( {
								zIndex : 5
							}).add();
						c = j.sliced ? j.slicedTranslation : [ a.plotLeft,
								a.plotTop ];
						e.translate(c[0], c[1]);
						...
						if (d)
							...
							j.graphic = b.arc(h).attr(pa(j.pointAttr[hb], {
				...
				drawDataLabels : function() {
					var a = this.data, b, c = this.chart, d = this.options.dataLabels, e = C(
							d.connectorPadding, 10), f = C(d.connectorWidth, 1), g, h, j = d.distance, l = this.radiusY, n = j > 0, J = this.center[1], D = [
							[], [] ], aa, E, da, w, R = 2, B;
					if (d.enabled) {
						...
						for (a = D[0][0] && D[0][0].dataLabel
								&& ja(D[0][0].dataLabel.styles.lineHeight); R--;) {
							var K = [], S = [], I = D[R], za = I.length, Da;
							for (B = J + l - j; B <= J - l + j; B += a)
								K.push(B);
							da = K.length;
							if (za > da) {
								h = [].concat(I);
							...
							for (B = 0; B < za; B++) {
								...
								if (n && f) {
									g = b.connector;
									h = [ ab, aa + (h[6] === "left" ? 5 : -5),
											E, La, aa, E, La, h[2], h[3], La,
											h[4], h[5] ];
									if (g) {
										g.animate( {
											d : h
