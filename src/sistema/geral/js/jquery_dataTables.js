...
var sStdMenu='<select class="formularioOrdenar" size="1" '+sName+'><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select>';
...
for(var i=0,iLen=an.length;i<iLen;i++){an[i].style.visibility=b?"visible":"hidden"
